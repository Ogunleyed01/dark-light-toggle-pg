            ...
            <div className='flex-1 space-y-6 lg:space-y-7'>
              <div className='space-y-4 lg:space-y-5'>
                <div className='flex items-center'>
                  ...
                  <h2 className='inline-block px-3 py-1.5 lg:px-4 lg:py-2 rounded-full bg-neutral-900 text-amber-400 font-medium text-sm backdrop-blur-sm border border-medium-800/50'>
                    <i className='bx bx-trending-up mr-1'></i>
                    Next Generation Design System
                  </h2>
                </div>
                <h1 className='text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabond tracking-tight text-neutral-900 dark:text-white'>
                ...
                <p className='text-base lg:textlg text-neutral-700 dark:text-neutral-300 max-w-2xl font-light'>
              ...
              <div className='flex flex-wrap gap-3 lg:gap-4'>
                <button className='px-6 py-3 lg:px-7 lg:py3.5 rounded-lg bg-neutral-900 hover:bg-black text-white dark:bg-amber-500 dark:hover:bg-amber-600 dark:text-neutral-900 font-medium shadow-lg hover:shadow-neutral-900/20 dark:hover:shadow-amber-500/20 flex items-center transition group'>
                  <i className='bx bx-code-alt mr-2 lg:mr-3 text-lg lg:text-xl group-hover:rotate-12 transition-transform'></i>
                  <span>Start Coding</span>
                </button>
                <button className='px-6 py-3 lg:px-7 lg:py3.5 border border-neutral-300 dark:border-neutral-700 rounded-lg bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-900 dark:text-white font-medium  flex items-center transition group'>
                  <i className='bx bx-book-open mr-2 lg:mr-3 text-lg lg:text-xl opacity-70 group-hover:opacity-100 transition-opacity'></i>
                  <span>Documentation</span>
                </button>
              </div>
              <div className='flex flex-col lg:flex-row gap-5 sm:items-center pt-5 lg:pt-7 border-t border-neutral-200 dark:border-neutral-800'>
                <div className='flex -space-x-3'>
                  <img src="https://randomuser.me/api/portraits/women/21.jpg" alt="User" className='w-9 h-9 lg:w-10 lg:h-10 rounded-full border-3 border-white dark:border-neutral-900 object-cover' />
                  <img src="https://randomuser.me/api/portraits/men/12.jpg" alt="User" className='w-9 h-9 lg:w-10 lg:h-10 rounded-full border-3 border-white dark:border-neutral-900 object-cover' />
                  <img src="https://randomuser.me/api/portraits/women/24.jpg" alt="User" className='w-9 h-9 lg:w-10 lg:h-10 rounded-full border-3 border-white dark:border-neutral-900 object-cover' />
                  <span className='flex justify-center items-center w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-white dark:border-neutral-900 bg-neutral-900 dark:bg-amber-500 text-white dark:text-neutral-900 text-xs font-medium'>
                    +5k
                  </span>
                </div>
                <div className='space-y-1 '>
                  ...
                  <p className='text-neutral-600 dark:text-neutral-400 text-sm'>
                    Trusted by  <span className='font-bold text-neutral-900 dark:text-white'> 5,000+ </span> 
                ...
                <div className='relative'>
                  ...
                  <div className='relative bg-white dark:bg-neutral-900 p-4 lg:p-5 xl:p-6 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800'>
                    <div className='flex items-center justify-between mb-3 lg:mb-4'>
                      ...
                      <div className='text-xs text-neutral-500 lg:text-neutral-400'>
                        eDave.Jsx
                      </div>
                    </div>
                    <div className='h-56 md:h-64 lg:h-60 xl:h-72 rounded-lg bg-neutral-100 dark:bg-neutral-800 overflow-hidden relative '>
                      <img src="/images/light-mode-ss.png" alt="Code snippet for light mode" className='w-full h-full object-cover object-left-top dark:hidden' />
                      <img src="/images/dark-mode-ss.png" alt="Code snippet for dark mode" className='w-full h-full object-cover object-left-top dark:block' />
                    ...
                    <div className='mt-3 lg:mt-4 flex justify-between items-center '>
                      ...
                      <button className='w-8 h-8 lg:w-9 lg:h-9 xl:w-10 xl:h-10 flex justify-center items-center rounded-full bg-amber-500 text-neutral-900 hover:bg-amber-600 transition'>
